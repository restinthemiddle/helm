...
*/}}
{{- define "restinthemiddle.fullname" -}}
...
Selector labels
*/}}
{{- define "restinthemiddle.selectorLabels" -}}
app.kubernetes.io/name: {{ include "restinthemiddle.name" . }}
